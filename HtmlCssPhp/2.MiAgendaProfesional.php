...
<div class="TituloAgedaPersonal"><p>Mi Agenda Profesional</p></div>
...
$sql ="SELECT id FROM profesional;";
...
echo '<p>', "<a href='3.DatosDelContacto(2).php?id=$numero'>", "Contacto", $row['id'], "</a> </p>";
